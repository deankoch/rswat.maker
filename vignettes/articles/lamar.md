...
<img src="lamar_files/figure-gfm/overview-catch-plot-1.png" alt="Figure 1. Three models of the Lamar River: from NHDPlus (left), rswat.maker (middle), and QSWAT+ (right)." width="33%" /><img src="lamar_files/figure-gfm/overview-catch-plot-2.png" alt="Figure 1. Three models of the Lamar River: from NHDPlus (left), rswat.maker (middle), and QSWAT+ (right)." width="33%" /><img src="lamar_files/figure-gfm/overview-catch-plot-3.png" alt="Figure 1. Three models of the Lamar River: from NHDPlus (left), rswat.maker (middle), and QSWAT+ (right)." width="33%" />
<p class="caption">
Figure 1. Three models of the Lamar River: from NHDPlus (left),
rswat.maker (middle), and QSWAT+ (right).
</p>

</div>

The final output is a set of three SWAT+ models and a parent QSWAT+
project for each one (plotted in Figure 1, right), all linked together
at the circled gage sites. By default the package looks for gages with
service records on the [National Water Information
System](https://waterservices.usgs.gov) (NWIS) of the USGS, and it will
maintain a copy of current and historical NWIS flow data on your local
machine.
...
in Figure 1 (left). We set its (WGS84) coordinates in R like so:
...
<img src="lamar_flowchart/flow_chart_rswat.png" alt="Figure 2. A flow chart for `rswat.maker` splits the whole process into four phases" width="75%" />
<p class="caption">
Figure 2. A flow chart for `rswat.maker` splits the whole process into
four phases
</p>
...
keyword `what='data'`, which runs only Phase “A” in Figure 2.
...
`plot_catch`. For example the left panel of Figure 1, which shows the
catchment, streams, and lakes, was generated by this simple function
call
...
grey circles in Figure 1 (middle).
...
<img src="lamar_files/figure-gfm/nwis-plot-1.png" alt="Figure 3. Hydrograph of stream flow from the Lamar River basin, measured near Tower Ranger Station"  />
<p class="caption">
Figure 3. Hydrograph of stream flow from the Lamar River basin, measured
near Tower Ranger Station
</p>
...
<img src="lamar_files/figure-gfm/dem-plot-1.png" alt="Figure 4. The National Elevation Dataset over the Lamar River basin with and without masking" width="50%" /><img src="lamar_files/figure-gfm/dem-plot-2.png" alt="Figure 4. The National Elevation Dataset over the Lamar River basin with and without masking" width="50%" />
<p class="caption">
Figure 4. The National Elevation Dataset over the Lamar River basin with
and without masking
</p>
...
from the project, as in Figure 4 (left). The number in parenthesis is
the “COMID” key for the main outlet, which relates it to other objects
in the NHDPlus model.
...
<img src="lamar_files/figure-gfm/land-plot-1.png" alt="Figure 6. The National Land Cover Database over the Lamar River basin"  />
<p class="caption">
Figure 6. The National Land Cover Database over the Lamar River basin
</p>
...
<img src="lamar_files/figure-gfm/soil-plot-1.png" alt="Figure 7. STATSGO2/SSURGO soil map unit keys (MUKEYS) over the Lamar River basin"  />
<p class="caption">
Figure 7. STATSGO2/SSURGO soil map unit keys (MUKEYS) over the Lamar
River basin
</p>
...
with the Lamar River, we could use the hydrograph in Figure 3.
...
<img src="lamar_files/figure-gfm/splitter-subcatchments-plot-1.png" alt="Figure 8. Subcatchments of the Lamar River, linked at NHPlus outlets (white circles)" width="33%" /><img src="lamar_files/figure-gfm/splitter-subcatchments-plot-2.png" alt="Figure 8. Subcatchments of the Lamar River, linked at NHPlus outlets (white circles)" width="33%" /><img src="lamar_files/figure-gfm/splitter-subcatchments-plot-3.png" alt="Figure 8. Subcatchments of the Lamar River, linked at NHPlus outlets (white circles)" width="33%" />
<p class="caption">
Figure 8. Subcatchments of the Lamar River, linked at NHPlus outlets
(white circles)
</p>
...
with argument `sub=TRUE`. For example, we generated Figure 1 (middle)
...
white and grey points in the Soda Butte Creek headwater (Figure 8,
right) lie on the same COMID polygon, so under that model we cannot
distinguish their catchments. While it may be obvious that the grey
point drains a smaller area, it is not so obvious how to (accurately)
revise the catchment boundary.
...
a different tone of fill colour to make it more obvious (as in Figure 8,
middle).
...
run setup on the subcatchment in Figure 8 (middle).
...
<img src="lamar_files/figure-gfm/qswat-plot-1.png" alt="Figure 9. Two models of Soda Butte Creek subcatchment geometries: from NHDPlus (left) and QSWAT+ (right)" width="50%" /><img src="lamar_files/figure-gfm/qswat-plot-2.png" alt="Figure 9. Two models of Soda Butte Creek subcatchment geometries: from NHDPlus (left) and QSWAT+ (right)" width="50%" />
<p class="caption">
Figure 9. Two models of Soda Butte Creek subcatchment geometries: from
NHDPlus (left) and QSWAT+ (right)
</p>
...
layout of subbasins. For example in Figure 1 (right) the number of
subbasins per unit subcatchment area is fixed, resulting in more detail
along the well-gaged Soda Butte Creek versus the rest of the Lamar
basin. Here is that plot again with subcatchments coloured differently.
...
<img src="lamar_files/figure-gfm/splitter-bigger-plot-1.png" alt="Figure 10. QSWAT+ models for three Lamar River subcatchments with NWIS gages at the circled sites"  />
<p class="caption">
Figure 10. QSWAT+ models for three Lamar River subcatchments with NWIS
gages at the circled sites
</p>
...
<img src="lamar_files/figure-gfm/splitter-yellowstone-plot-1.png" alt="Figure 11. Subcatchments in the Upper Yellowstone River basin, with Lamar River basin highlighted in red"  />
<p class="caption">
Figure 11. Subcatchments in the Upper Yellowstone River basin, with
Lamar River basin highlighted in red
</p>
...
This configuration of inlets and outlets in Figure 11 naturally leads to
a subcatchment-level parallelization scheme: Headwater subcatchments can
...
chunk, which colors the 18 subcatchments from Figure 11 according to the
stage at which they would be simulated. To effect a parallelized
simulation, users could replace the `plot_catch` call below with a call
to the SWAT+ simulator followed by an update to any dependent inlet
files (*eg* using `rswat`).
...
<img src="lamar_files/figure-gfm/parallel-plot-1.png" alt="Figure 12. Subcatchments colored according to their order in a SWAT+ parallelization scheme"  />
<p class="caption">
Figure 12. Subcatchments colored according to their order in a SWAT+
...
subcatchments. This is illustrated in Figure 12 as a series of darkening
colours, from yellow to purple. In the first three stages (and
particularly in the first), the simulator’s work is efficiently split
into several parallelizable chunks.
