...
`rswat.maker` makes SWAT+ models. See our other project [`rswat`](https://github.com/deankoch/rswat) for an R-based editing and simulation manager.
...
can complete most of the workflow (steps 1-6) without installing it. This data-only workflow should function on platforms other than Windows, but that has not yet been tested. Userse who want to build SWAT+ models must run the official [SWAT+ installer](https://swat.tamu.edu/software/plus/) for Windows
(last tested with v2.3.1, released 2023-07-13), as `rswat.maker` depends on that software to complete steps 7-9.
