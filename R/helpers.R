...
#' 
#' If `first_only=TRUE` the function returns only the COMID(s) found immediately
#' upstream (if any).
#' 
...
#' it from `nhdR` - but it can be any data frame with the same type of graph structure
